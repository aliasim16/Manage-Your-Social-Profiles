      ...
      <div className="container channels_container " data-theme={theme} >
        <div className="row">
          <div className="col-sm channels_header">
              ...
              <img className="container" src="Images\Channels\channels_logos.png" alt="" />
              ...
              <div className="channels_logos">
                <div className="tiktok">
                  <img src="Images\Channels\tiktok.png" alt="tiktok" />
                </div>
                <img id="twitch" src="Images\Channels\twitch.png" alt="" />
